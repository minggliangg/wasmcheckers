(module
  ...
  ;; Blacks get crowned on row 0, White gets crowned on row 7
  ...
  ;; Manually plave each piece on the board to initialise the game
  (func $initBoard
    ...
    (call $setTurnOwner (i32.const 1)) ;; Black go first
  )
