fetch('./checkers.wasm').then(response => response.arrayBuffer()).then(bytes => WebAssembly.instantiate(bytes, {
    events: {
    ...
    instance.exports.move(1, 1, 1, 0); // W
    document.getElementById("container").innerText = instance.exports.move(0, 0, 0, 2); // B - move the crowned piece out
